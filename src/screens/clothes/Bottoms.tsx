// src/screens/clothes/Bottoms.tsx
    ...
    useCallback(() => {
      const fetchBottoms = async () => {
        try {
          ...
          setItems(data.filter(item => item.category === 'bottom'));
        } catch (err) {
